<template>
  <div class="bg-gray-50">
    ...
    <div class="fixed bottom-4 right-4 z-50 flex flex-col items-end">
      <button @click.stop="toggleContact" class="bg-green-600 text-white p-4 rounded-full shadow-xl hover:bg-green-700 transition-all duration-300 ease-in-out transform hover:scale-105 flex items-center justify-center space-x-2 focus:outline-none focus:ring-2 focus:ring-green-500 focus:ring-opacity-50">
      ...
      <div v-if="showContactOptions" class="mt-3 bg-white p-5 rounded-xl shadow-2xl space-y-3 w-64 transform origin-bottom-right animate-fade-in-up">
        <a href="tel:0982496558" class="flex items-center space-x-2 text-gray-800 hover:text-green-600 transition duration-200 ease-in-out p-2 rounded-lg hover:bg-gray-100 hover:cursor-pointer">
          <img src="/images/067-phone.svg" alt="Phone Icon" class="w-6 h-6">
          <span class="text-lg font-medium">โทร: 098-2496558</span>
        </a>
        <a href="https://line.me/ti/p/@yourlineid" target="_blank" class="flex items-center space-x-2 text-gray-800 hover:text-green-600 transition duration-200 ease-in-out p-2 rounded-lg hover:bg-gray-100 hover:cursor-pointer">
          <img src="/images/line-1.svg" alt="Line Icon" class="w-6 h-6">
          <span>Line: @yourlineid</span>
        </a>
        <a href="#" class="flex items-center space-x-2 text-gray-800 hover:text-green-600 transition duration-200 ease-in-out p-2 rounded-lg hover:bg-gray-100 hover:cursor-pointer">
